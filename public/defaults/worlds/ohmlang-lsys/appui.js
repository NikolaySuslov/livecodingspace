                ...
                $components: [
                    ...
                    },
                    {
                        ...
                        $components: [
                            ...
                            {
                                $type: "img",
                                src: "/defaults/assets/lsys/Koch.jpg",
                    ...
                    },
                    {
                        ...
                        $components: [
                            ...
                            {
                                $type: "img",
                                src: "/defaults/assets/lsys/dragon.jpg",
                                class: "mdc-elevation--z2",
                                style: "width: 150px",
                                onclick: function (evt) {
                    ...
                    },
                    {
                        ...
                        $components: [
                            ...
                            {
                                $type: "img",
                                src: "/defaults/assets/lsys/SierpinskiCurve.jpg",
                                class: "mdc-elevation--z2",
                                style: "width: 150px",
                                onclick: function (evt) {
                    ...
                    },
                    {
                        ...
                        $components: [
                            ...
                            {
                                $type: "img",
                                src: "/defaults/assets/lsys/SierpinskiTriangle.jpg",
                                class: "mdc-elevation--z2",
                                style: "width: 150px",
                                onclick: function (evt) {
